...
interface MultiSelectProps
    ...
    /**
     * If true, enables single selection mode with radio buttons.
     * Optional, defaults to false.
     */
    single?: boolean;
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
    (
        ...
        const toggleOption = (optionValue: string) => {
            ...
            if (single) {
                // Single selection mode - only allow one selection
                                                        ...
                                                        </span>
                                                        {
                                                            !single && (
                                                                <div
                                                                    ...
                                                                    className="ml-2 h-4 w-4 flex items-center justify-center cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
                                                                    <XCircle
                                                                        className={cn(
                                                                            "h-3 w-3",
                                                                            responsiveSettings.compactMode &&
                    ...
                    <PopoverContent
                        ...
                        <Command>
                            ...
                            <CommandList
                                ...
                                {!hideSelectAll && !searchValue && !single && (
                                    <CommandGroup>
                                        <CommandItem
                                            key="all"
                                            onSelect={toggleAll}
                                            ...
                                            <div
                                                ...
                                                aria-hidden="true">
                                                <CheckIcon className={cn("h-4 w-4", getAllOptions().filter((opt) => !opt.disabled)
                                                    .length && "text-primary-foreground")} />
                                            </div>
                                            <span>
                                                (Select All
                                                    ...
                                                    <CommandItem
                                                        ...
                                                        {single ? (
                                                            ...
                                                            <div
                                                                ...
                                                                aria-hidden="true">
                                                                <CheckIcon className={cn("h-4 w-4", isSelected && "text-primary-foreground")} />
                                                            </div>
                                                        )}
                                                        {option.icon && (
                                                            <option.icon
