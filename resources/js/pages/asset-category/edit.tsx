...
const AssetCategoryUpdatePage = forwardRef<AssetCategoryUpdatePageRef, { assetCategory: AssetCategory | null, onClose?: () => void }>(({ assetCategory, onClose }, ref) => {
    const sheetRef = useRef<HTMLDivElement>(null)
    const { data, setData, put, processing, errors, reset, isDirty, setDefaults, transform } = useForm<{ name: string, description?: string }>({
        name: '',
        description: ''
    });
