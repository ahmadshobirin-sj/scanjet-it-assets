        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <AppContainer className="space-y-6">
                <AppTitle
                    ...
                    actions={
                        <>
                            <Button variant="fill" intent="warning" leading={<SquarePen />} onClick={() => router.visit(route('manufacture.edit', { manufacture: manufacture?.data.id }))}>
                                Edit manufacture
                            </Button>
                        </>
                    }
                        ...
                        <InfoListContainer hasGroups>
                            <InfoListGroup title="Manufacture Information" columns={2}>
                                ...
                                <InfoList direction="column">
                                    ...
                                    <InfoListContent>
                                        {manufacture.data.email ? (
                                            <a
                                                href={`mailto:${manufacture.data.email}`}
                                                target="_blank"
                                ...
                                <InfoList direction="column">
                                    ...
                                    <InfoListContent>
                                        {manufacture.data.website || '-'}
                                    </InfoListContent>
                                </InfoList>
                                <InfoList direction="column">
                                    <InfoListLabel>Address</InfoListLabel>
                                    <InfoListContent>
                                        {manufacture.data.address || '-'}
                                    </InfoListContent>
                                </InfoList>
                            </InfoListGroup>
                            ...
                            <InfoListGroup title="Contact Person" columns={2}>
                                <InfoList direction="column">
                                    <InfoListLabel>Name</InfoListLabel>
                                    <InfoListContent>
                                        {manufacture.data.contact_person_name || '-'}
                                    </InfoListContent>
                                </InfoList>
                                ...
                                <InfoList direction="column">
                                    <InfoListLabel>Phone</InfoListLabel>
                                    <InfoListContent>
                                        {manufacture.data.contact_person_phone || '-'}
                                    </InfoListContent>
                                </InfoList>
                                ...
                                <InfoList direction="column">
                                    ...
                                    <InfoListContent>
                                        {manufacture.data.contact_person_email ? (
                                            <a
                                                href={`mailto:${manufacture.data.contact_person_email}`}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                                {manufacture.data.contact_person_email}
